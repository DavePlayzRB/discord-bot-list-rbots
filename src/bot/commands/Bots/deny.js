...
const reasons = {
    ...
    "7": `Your bot has a prefix of 'dl!', 'b!' or has multiple prefixes`,
    "8": `Your bot has admin as the only permission`,
    "9": `Your bot is not in the language english`,
    "10":`Your bot is breaking the Discord ToS`,
    "11": `Your bot is breaking the Discord Lists/ToS/Rules`
}
var modLog;
...
module.exports = class extends Command {
    constructor(...args) {
        super(...args, {
            ...
            description: "Deny a bot from the botlist",
            usage: '[Member:user]'
        });
    }
    ...
    async run(message, [Member]) {
        ...
        message.channel.send(`Denied <@${bot.botid}> Check <#${mod_log_id}>.`)
